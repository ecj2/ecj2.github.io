...
function loadResources() {
  ...
  font_pixel = Momo.loadFont("uploads/games/blox/data/pixelade.ttf");

  image_tiles = Momo.loadBitmap("uploads/games/blox/data/tiles.png");

  sound_push = Momo.loadSample("uploads/games/blox/data/push.mp3");
  sound_goal = Momo.loadSample("uploads/games/blox/data/goal.mp3");
  sound_error = Momo.loadSample("uploads/games/blox/data/error.mp3");
